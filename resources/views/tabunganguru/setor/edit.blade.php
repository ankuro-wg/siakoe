...
<section class="content card" style="padding: 10px 10px 10px 10px ">
    <div class="box">
        ...
        @endif
        <form action="/tabunganguru/setor/{{$setor->id}}/update" method="POST">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <input value="{{$setor->guru->no_hp}} {{$setor->guru->nama}}" name="jumlah" type="text" class="form-control bg-disabled" id="jumlah" disabled>
            ...
            <a class="btn btn-danger btn-sm" href="/tabunganguru/setor/index" role="button"><i class="fas fa-undo"></i>
                BATAL</a>
        </form>
    </div>
</section>
