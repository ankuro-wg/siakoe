        ...
        <div class="invoice p-3 mb-3">
          ...
          <div class="row invoice-info">
            <div class="col-sm-4 invoice-col">
              ...
              <address>
                <strong>{{$tarik->guru->nama}}</strong><br>
                Tempat, Tanggal Lahir : {{$tarik->guru->tempat_lahir}}, {{$tarik->guru->tanggal_lahir}}<br>
                Jenis Kelamin : {{$tarik->guru->jenis_kelamin}}<br>
                No HP : {{$tarik->guru->no_hp}}<br>
              </address>
            </div>
            <!-- /.col -->
            <div class="col-sm-4 invoice-col">
            ...
            <div class="col-sm-4 invoice-col">
              <br>
              <b>Nomor Berkas : *{{$tarik->guru->no_hp}}-0{{$tarik->id}}</b><br>
          ...
          <div class="row no-print">
            <div class="col-12">
              <a class="btn btn-danger btn-sm my-1 mr-1 float-right" href="/tabunganguru/tarik/index" role="button"><i class="fas fa-undo"></i> KEMBALI</a>
              <a href="/tabunganguru/tarik/{{$tarik->id}}/cetakprint" target="_blank" class="btn btn-primary btn-sm my-1 mr-1 float-right"><i class="fas fa-print"></i> CETAK</a>
            </div>
          </div>
        </div>
        <!-- /.invoice -->
